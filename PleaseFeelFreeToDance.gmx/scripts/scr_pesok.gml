...
while (ds_grid_value_exists(map_water,xm-2,ym-2,xm+2,ym+2,1))
...
ds_grid_set(map_pesok,xm,ym,1);

sir=irandom_range(5,15);
...
xm+=1;                
    ...
    if ds_grid_get(map_pesok,xm,ym)=1
    and (xm<=92)                   
   {
                                                                         
    while  ds_grid_get(map_pesok,xm,ym)=1
    and (xm<=92)                   
        {
        xm+=1;                
        if (xm>92)                     
